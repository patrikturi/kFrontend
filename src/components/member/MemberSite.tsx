        ...
        <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form className="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div className="input-group">
              <input type="text" className="form-control bg-light border-0 small" placeholder="Search player..." aria-label="Search" aria-describedby="basic-addon2" />
                ...
                <div className="card-body">
                  <div className="row no-gutters align-items-center">
                    <div className="col mr-2">
                      <div className="text-xs font-weight-bold text-warning text-uppercase mb-1">kSoccer points</div>
                      <div className="h5 mb-0 font-weight-bold text-gray-800">500</div>
                    </div>
                    <div className="col-auto">
                      <FontAwesomeIcon icon={faTrophy} className="fa-2x text-gray-300" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-xl-3 col-md-6 mb-4">
              <div className="card border-left-primary shadow h-100 py-2">
                <div className="card-body">
                  <div className="row no-gutters align-items-center">
                    <div className="col mr-2">
                      <div className="text-xs font-weight-bold text-primary text-uppercase mb-1">Goals</div>
                      <div className="h5 mb-0 font-weight-bold text-gray-800">99</div>
                    </div>
                    <div className="col-auto">
                      <FontAwesomeIcon icon={faFutbol} className="fa-2x text-gray-300"/>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-xl-3 col-md-6 mb-4">
              <div className="card border-left-success shadow h-100 py-2">
                <div className="card-body">
                  <div className="row no-gutters align-items-center">
                    <div className="col mr-2">
                      <div className="text-xs font-weight-bold text-success text-uppercase mb-1">Assists</div>
                      <div className="h5 mb-0 font-weight-bold text-gray-800">99</div>
                    </div>
                    <div className="col-auto">
                      <FontAwesomeIcon icon={faHandsHelping} className="fa-2x text-gray-300" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-xl-3 col-md-6 mb-4">
              <div className="card border-left-info shadow h-100 py-2">
                <div className="card-body">
                  <div className="row no-gutters align-items-center">
                    <div className="col mr-2">
                      <div className="text-xs font-weight-bold text-info text-uppercase mb-1">Matches</div>
                      <div className="h5 mb-0 font-weight-bold text-gray-800">99</div>
                    </div>
                    <div className="col-auto">
                      <FontAwesomeIcon icon={faStopwatch} className="fa-2x text-gray-300" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-xl-8 col-lg-7">
              <div className="card shadow mb-4">
                ...
                <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 className="m-0 font-weight-bold text-primary">Last system updates</h6>
                </div>
                {/*<!-- Card Body -->*/}
                <div className="card-body">
                  <p>Bug fix.</p>
